export namespace env {
    ...
    export declare function createCallFunctionPromise(contract: usize, method: usize, args: usize, amount: usize, gasLimit: usize): i32

    //@ts-ignore
    @external("env", "promise_then")
    export declare function then(promiseIdx : i32, method: usize, args: usize, amount: usize, gasLimit: usize): i32
